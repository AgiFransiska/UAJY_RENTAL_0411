...
public class LaporanPerfomaDriverTransaksiAdapter extends RecyclerView.Adapter<LaporanPerfomaDriverTransaksiAdapter.MyViewHolder> {
    private List<LaporanTop5Driver> laporanTop5DriverModelList;
    private Context context;

    public LaporanPerfomaDriverTransaksiAdapter(List<LaporanTop5Driver> laporanTop5DriverModels) {
    ...
    @Override
    public LaporanPerfomaDriverTransaksiAdapter.MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_laporan4, parent, false);
        LaporanPerfomaDriverTransaksiAdapter.MyViewHolder mViewHolder = new LaporanPerfomaDriverTransaksiAdapter.MyViewHolder(mView);
        return mViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull LaporanPerfomaDriverTransaksiAdapter.MyViewHolder holder, int position) {
